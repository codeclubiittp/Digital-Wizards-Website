...
const domains = [
  {
    ...
    backgroundImage: '/images/domainLogos/App_Negative.png'
  },
  {
    title: 'Architecture',
    description: 'Analyzing and interpreting complex data to drive decisions.',
    backgroundImage: '/images/domainLogos/C.Arch_Negative.png'
  },
  {
    ...
    backgroundImage: '/images/domainLogos/CP_Negative.png'
  },
  {
    title: 'Cyber Security',
    description: 'Protecting systems and networks from digital attacks.',
    backgroundImage: '/images/domainLogos/Cyber_Negative.png'
  },
  {
    title: 'Software Engineering',
    description: 'Designing, developing, and testing software systems.',
    backgroundImage: '/images/domainLogos/DevOps_Negative.png'
  },
  {
    title: 'Web Development',
    description: 'Building and maintaining websites and web applications.',
    backgroundImage: '/images/domainLogos/WebDevLogo.png'
  }
];
          ...
          <Link to={`/domain/${domain.title.toLowerCase().replace(/\s+/g, '-')}`} key={index}>
            ...
            <img className="scale-[200%] translate-y-1/3" src = {domain.backgroundImage} alt = {domain.title}/>
              ...
              <div className="relative z-10 flex flex-col items-center text-center text-white">
                {/* Domain Title */}
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">{domain.title}</h2>
                {/* Domain Description */}
