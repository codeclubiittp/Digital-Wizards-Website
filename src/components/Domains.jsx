          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center text-white">
              ...
              <div className="flex space-x-2 mt-2">
                <span className="px-3 py-1 text-xs sm:text-sm font-semibold bg-white bg-opacity-20 rounded-full">Explore</span>
                <span className="px-3 py-1 text-xs sm:text-sm font-semibold bg-white bg-opacity-20 rounded-full">Learn More</span>
              </div>
            </div>
          </div>
        ))}
